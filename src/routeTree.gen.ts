...
import { Route as AppshellFlowsRouteImport } from './routes/_appshell.flows'
...
const AppshellFlowsRoute = AppshellFlowsRouteImport.update({
  id: '/flows',
  path: '/flows',
  getParentRoute: () => AppshellRoute,
} as any)
...
const AppshellFlowsIndexRoute = AppshellFlowsIndexRouteImport.update({
  id: '/',
  path: '/',
...
export interface FileRoutesById {
  ...
  '/_appshell/flows/': typeof AppshellFlowsIndexRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_appshell/flows': {
      ...
      path: '/flows'
      fullPath: '/flows'
      preLoaderRoute: typeof AppshellFlowsRouteImport
      parentRoute: typeof AppshellRoute
    }
    '/_appshell/dashboard': {
    ...
    '/_appshell/flows/': {
      ...
      path: '/'
      fullPath: '/flows/'
      preLoaderRoute: typeof AppshellFlowsIndexRouteImport
